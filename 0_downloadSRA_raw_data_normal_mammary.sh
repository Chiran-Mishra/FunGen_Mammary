...
DD=/scratch/${MyID}/Project/rawfile			## Example: DD=/scratch/${MyID}/PracticeRNAseq/RawData
...
fastq-dump -F --split-files SRR7819866
 #fastq-dump -F --split-files SRR7819868
 #fastq-dump -F --split-files SRR7819892
 #fastq-dump -F --split-files SRR7819917
 #fastq-dump -F --split-files SRR7819921
 #fastq-dump -F --split-files SRR7819925
 #fastq-dump -F --split-files SRR7819928
 #fastq-dump -F --split-files SRR7819931
 #fastq-dump -F --split-files SRR7819933
 #fastq-dump -F --split-files SRR7819935
 #fastq-dump -F --split-files SRR7819941
 #fastq-dump -F --split-files SRR7819945
 #fastq-dump -F --split-files SRR7819786
 #fastq-dump -F --split-files SRR7819795
 #fastq-dump -F --split-files SRR7819800
 #fastq-dump -F --split-files SRR7819802

...
DD=/scratch/${MyID}/Project/rawfile/correct			## Example: DD=/scratch/${MyID}/PracticeRNAseq/RawData
WD=/scratch/${MyID}/Project/rawfile		## Example: WD=/scratch/${MyID}/PracticeRNAseq

...
WD=/scratch/$MyID/Project                 ## Example: WD=/scratch/$MyID/PracticeRNAseq
DD=/scratch/$MyID/Project/rawfile/extra_1      ## Example: DD=/scratch/$MyID/PracticeRNAseq/RawData
CD=/scratch/$MyID/Project/CleanData_Normal ## Example: CD=/scratch/$MyID/PracticeRNAseq/CleanData
